...
def exportar_da_db():
    ...
    try:
        ...
        with open(os.path.join(pasta_exportacao, "usuarios.csv"), "w", newline="", encoding="utf-8-sig") as f:
            writer = csv.writer(f)
        ...
        with open(os.path.join(pasta_exportacao, "estoque.csv"), "w", newline="", encoding="utf-8-sig") as f:
            writer = csv.writer(f)
        ...
        with open(os.path.join(pasta_exportacao, "historico_movimentacoes.csv"), "w", newline="", encoding="utf-8-sig") as f:
            writer = csv.writer(f)
